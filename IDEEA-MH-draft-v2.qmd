...
pDemand <- getData(sns[[1]], "pDemand", merge = T, process = T
                   # year = report_years
                   ) |>
...
```{r}
all_slices <- sns$CAP_2050@settings@calendar@timetable$slice

# (very) quick plots to use
# ?ideea_snapshot
ideea_snapshot2(sns$REF_2070, YEAR = 2070, SLICE = all_slices[1:24])
...
```{r}
ideea_snapshot2(sns$CAP_2050, YEAR = 2050, SLICE = all_slices[1:24])
