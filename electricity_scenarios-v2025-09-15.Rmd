...
horizon_2025_2070_by_20 <-
  newHorizon(
  name = "Y2020_2070_by_20",
  desc = "2020 to 2070 by 20 years",
  period = 2025:2070,
  intervals = c(1, 10, rep(20, 15)),
  mid_is_end = T
)
horizon_2025_2070_by_20@intervals$mid[3] <- 2050
...
scen_REF <- interpolate(
  mod,
  name = "REF",
  horizon = horizon_2025_2070_by_20
)

# Writing the model script and data
scen_REF <- write_sc(
  scen_REF
  # solver_options$pyomo_cplex
