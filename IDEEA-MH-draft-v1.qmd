...
pDemand <- getData(sns$CAP, "pDemand", merge = T, process = T
                   # year = report_years
                   ) |>
...
# pDemand <- pDemand |>
  ...
  mutate(
    datetime = tsl2dtm(slice, tmz = "Asia/Kolkata", year = 2024), 
...
elc_MH <- load_curve_2025 |>
  ...
  filter(year %in% 2024) |> # comment this line to plot 2024-2025
...
vTechCap_SW <- getData(sns$CAP, name = "vTechCap", merge = T, 
...
## Solar installatons 2025-2050 by region, GW
...
## Wind installatons 2025-2050, GW
...
## Thermal installatons 2025-2050, GW
...
# ?ideea_snapshot
ideea_snapshot2(sns[[1]], YEAR = 2050, SLICE = all_slices[1:24])
...
```{r}
ideea_snapshot2(sns$CAP, YEAR = 2050, SLICE = all_slices[1:24])
...
## Curtailed generation in 2050 (heatmap)
